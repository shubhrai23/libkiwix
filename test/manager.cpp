...
TEST(ManagerTest, parseOpdsDomAddsEntriesAndParsesSearchMetadata)
{
    ...
    EXPECT_TRUE(manager.parseOpdsDom(doc, "http://example.com", /*libraryPath=*/"", /*readOnly=*/false));
...
TEST(ManagerTest, parseOpdsDomHonorsReadOnly)
{
...

    {
      auto lib = kiwix::Library::create();
      TestManager manager(lib);
      EXPECT_TRUE(manager.parseOpdsDom(doc, "http://example.com", /*libraryPath=*/"", /*readOnly=*/true));
...
TEST(ManagerTest, parseOpdsDomWithInvalidSelfPath)
{
    ...
    EXPECT_TRUE(manager.parseOpdsDom(doc, "http://example.com", /*libraryPath=*/"./test/lib.xml", /*readOnly=*/false));
